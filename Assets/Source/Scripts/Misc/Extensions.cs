...
namespace TanksArmageddon
{
    ...
    {
        public static Vector3 SetValues(this Vector3 vector, float x = float.NaN, float y = float.NaN, float z = float.NaN)
        {
            return new Vector3 (
        ...
        public static Vector2 SetValues(this Vector2 vector, float x = float.NaN, float y = float.NaN)
        {
            return new Vector2(
                SelectCorrectValue(x, vector.x),
                SelectCorrectValue(y, vector.y)
